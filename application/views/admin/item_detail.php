	<div id="main">
    	<div id="nav">
        	<h3>商品细节列表</h3>
            <a style="color:#68228B;" class="other_link" href="<?php echo site_url('admin/item_detail/invalid');?>">无效细节</a>
            <span class="other_link"> &nbsp;|&nbsp; </span>
            <a class="other_link" href="<?php echo site_url('admin/item_detail/add');?>">添加商品细节</a>
        </div>
	...
	<script type="text/javascript">
        ...
        function searchOperation() {
            ...
            $.ajax({
                url : admin_url + "item_detail/search_detail",
        ...
        function invalidDetail(detail_id) {
            if(confirm("是否设为无效？")) {
                $.ajax({
                    url : admin_url + "item_detail/invalid_item_detail",
